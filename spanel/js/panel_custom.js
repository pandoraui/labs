...
$(function(){
	...
	$("#panel_control").click(function(){
		if(ani_swi==true){
			  $(this).animate({"margin-left":"0"},ani_time,function(){
				  $("div.panel_aside").hide();
			  });
			  $("div.panel_content").animate({"margin-left":"7px"},ani_time);
			  ani_swi=false;
		}else{
			$(this).animate({"margin-left":"350px"},ani_time,function(){
				$("div.panel_aside").show();
			});
			$("div.panel_content").animate({"margin-left":"357px"},ani_time);
			ani_swi=true;
		}
	});
	...
	// 无限极菜单展开收起
	$("span.simple_ico").bind('click',function(){
		var _this_item = $(this).parent("li");
		//alert(_this_item.hasClass("expand_item"));
