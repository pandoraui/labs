...
$(function(){
	...
	xh_hover("div.from-box","from-box-hover");
	
	$("div.from-box").click(function(e){
		var obj = e.target || e.srcElement;
		if(obj.className!="from-citylist"){
			$(this).toggleClass("from-box-selected");
		}
	});
	...
	// 临时取消了下面逻辑的开发，以后会用到,这个是backup备份页面，供预览效果使用
	// 酒店项信息与日历展开与收起
	// var _itemprev = null;
