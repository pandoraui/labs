    ...
    <div class="search-main search-tickets">
        ...
        <div class="search-filter">
            ...
            <ul class="filter-tags">
				...
				<li>
                    <span>房价范围：</span>
                    <label><input name="hotel-price" value="" type="radio">不限</label>
                    <label><input name="hotel-price" value="" type="radio">200元以下</label>
                    <label><input name="hotel-price" value="" type="radio">200-499元</label>
                    <label><input name="hotel-price" value="" type="radio">500-799元</label>
                    <label><input name="hotel-price" value="" type="radio">800元以上</label>
                </li>
                <li>
                    <span>酒店星级：</span>
        ...
        <div id="viewpoint-box" class="search-result-box viewpoint-box type_simple_result">
