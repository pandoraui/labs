		...
		<div class="search-result-box search-line-list">
            ...
            <div class="filter-order">
                ...
                <span class="priceform">
                    <form class="J_price">
                        <input type="text" value="300" class="input-text"> - <input type="text" value="最高价" class="input-text">
                        <i class="empty">清空</i><input type="button" class="button" value="确定">
                    </form>
                </span>
                ...
                <input type="text" class="input-text input-result-search" value="在结果中搜索asdf"><input type="button" class="button" value="搜索"><i class="empty">清空</i>
                </form></div>
            </div><!-- //筛选排序 -->
