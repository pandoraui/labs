...
$(function () {
    ...
    function xboxListItemAuto(){
        $("ul.xulist").each(function(){
            ...
            //var xboxNum = Math.round(parseInt(xbox.css("margin-left"))/xboxitemw);
...
$(function(){
    ...
    $(".J_itemauto").each(function(i){
        //var fixed_top = elt_position($(this),"top");
        //var fixed_bottom = elt_position($(this),"bottom");
        //console.log(fixed_top,fixed_bottom)
        obj[i] = [elt_position($(this),"top"),elt_position($(this),"bottom")-70]
        //var fixed_nav = $(this).find(".J_fixed");
        //console.log(obj);
