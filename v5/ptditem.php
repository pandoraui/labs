    ...
    <dd class="pdetails">
        <div class="tiptext tip-light">
            ...
            <div class="tip-other">
                <div class="xtext">
                    <h4>入园须知</h4>
                    <p>1.营业时间：8:00—17:00（16:00停止换票）
                    取票时间：8：30—17：00</p>
                    <p>2.景区地址：上海市浦东新区南六公路178号取票地点：上海市松江佘山上海欢乐谷检票处电子门票专用通道。</p>
                    <p>3.入园凭证：刷二维码短信入园。短信游玩当日有效，不能删除、不能转发。如您在出行前一天17：00尚未收到短信，请速来电咨询。</p>
                </div>
                <div class="xtext">
                    <h4>适用范围</h4>
                    <p>全日制大专至全日制研究生（不分国籍，凭借有效学生证件刷码入园）</p>
                </div>
                <div class="xtext">
                    <h4>退改规则</h4>
                    <p>若需退改请提前一天晚上21：00前办理，逾期收取全额费用作为违约金。</p>
                </div>
            </div>
