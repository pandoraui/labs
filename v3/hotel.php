    ...
    <div class="aside-big">
        <div class="pro-search search-hotel">
            <div class="search-nav">
                <ul class="hor clearfix">
                    ...
                    <li class="selected"><a target="_blank" href="http://hotel.lvmama.com">境外景点酒店 <small>&raquo;</small></a></li>
                </ul>
            </div>
            <div class="content">
        ...
        <div class="side-box border hotel-tuan">
            ...
            <div class="content">
                <ul class="hotel-buy">
                    <li>
                        <h4>某酒店名称 <small class="m_star"><span class="mk_star m_star3"><i></i></span></small></h4>
                        <p class="info">住宿1晚除会员房（除会员房和专享房外，其他房型任选其一）</p>
                        <div class="imgtext">
                            ...
                            <div class="textbox">
                                <p>
                                    <dfn>&yen;<i>490</i></dfn>
                                    <span class="price">节省：&yen;800</span>
                                </p>
                                <p><a class="btn btn-orange B" href="#">&nbsp;&nbsp;抢购&nbsp;&nbsp;</a></p>
                            </div>
                        </div>
                    </li>
                    <li>
