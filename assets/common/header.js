 ...
 */
(function(){
    var headerhtml =  '<!-- 公共头部  --><!-- topbar\\ -->'
                    + '<div class="lv-topbar">'
                    + '    <div class="tapbar-inner wrap">'
                    + '        <ul class="top-link">'
                    + '            <li class="dropdown"><a class="lvlink" href="http://www.lvmama.com/myspace/index.do">我的驴妈妈 <i class="icon-barr"></i></a>'
                    + '                <div class="top-sub">'
                    ...
                    + '                </div>'
                    + '            </li>'
                    + '            <li class="dropdown"><a class="lvlink" href="http://login.lvmama.com/nsso/onlineApplyMemberCard/index.do">会员卡 <i class="icon-barr"></i></a>'
                    + '                <div class="top-sub">'
                    ...
                    + '                </div>'
                    + '            </li>'
                    + '            <li><a class="lvlink" href="http://www.lvmama.com/points">积分商城</a></li>'
                    + '            <li><a class="lvlink" href="http://www.lvmama.com/public/help">帮助</a></li>'
                    ...
                    + '            </li>'
                    + '            <li class="sitemap"><a class="lvlink" target="_self" href="javascript:bookmark()">收藏本站</a></li>'
                    + '            <li><a class="lvlink" href="http://e.weibo.com/lvmamas" rel="nofollow" target="_blank"><i class="icon-weibo"></i>+微博</a></li>'
                    ...
                    + '</div> <!-- //.topbar -->'
                    + ''
                    + '<div class="lv-header wrap">'
                    + '    <div class="header-inner">'
                    + '        <span id="hotline" class="lv-hotline">1010-6060</span>'
                    + '        <a class="lv-logo" href="http://www.lvmama.com/">自助天下游 就找驴妈妈</a>'
                    + '        <div id="adPro" class="lv-adPro"></div>'
                    + '    </div>'
                    + '</div> <!-- //div.lv-header -->'
                    + ''
                    ...
                    + '    <div class="wrap">'
                    + '        <ul class="pnav-main">'
                    + '            <li id="home"><a href="http://www.lvmama.com">首页</a></li>'
                    ...
                    + '            <li id="flight"><a href="http://flight.lvmama.com">国际机票</a><i class="icon-new"></i></li>'
                    + '            <li id="train"><a href="http://www.lvmama.com/train">火车票</a><i class="icon-new"></i></li>'
