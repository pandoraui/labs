...
$(function(){
	$(".last_child").each(function(){
	  $(this).find("li:last").addClass("current");
	})//最后一个元素添加特定样式
  ...
  tab_menu_li.mouseover(function(){
	...
	tab_click_li.click(function(){
  	$(this).toggleClass('selected')
  			 .siblings().toggleClass('selected');
  });
  ...
  $('.scoll_switch .scoll_box').eq(scoll_nav_li_index).addClass('selected')
	...
	$(".abhj .scoll").jCarouselLite({//滚动控制
		visible: 6,
		scroll: 1,
		auto: 4000,
		speed: 1000
    });
	$(".ab_sup .scoll").jCarouselLite({//滚动控制
	  vertical:true,
		visible: 6,
		scroll: 3,
		auto: 1000,
